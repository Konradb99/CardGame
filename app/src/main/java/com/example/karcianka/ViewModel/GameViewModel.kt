        ...
        when (this.checkpoint) {
            ...
            "01" -> {
                ...
                when (motionLayout.getCurrentState()) {
                    R.id.left -> {
                        ...
                        LocNav.AddChoice(
                            cardVM.card_back_text,
                            "A daj spokój z przywitaniem. Idziemy sie napić?",
                            "Nie dzisiaj.",
                            "Pewnie! Spotkajmy sie w Ministerstwie."
                        )

                        cardVM.card_back_text.text =
                            cardVM.card_back_text.text.toString() + "\n\n" + checkpoint;
            ...
            "011" -> {
                when (motionLayout.getCurrentState()) {
                    R.id.left -> {
                        ...
                        cardVM.card_back_text.text =
                            "I ty smiesz się nazywać studentem?\n" + checkpoint;
                    ...
                    R.id.right -> {
                        ...
                        walking = true;
                        LocNav.SetLoc(
                            cardVM.card_front, cardVM.card_back_text,
                            cardVM.card_back_title, thisloc
                        )
                        locleft = LocNav.GetRandomExit(thisloc);
                        locright = LocNav.GetRandomExit(thisloc);
                        ...
                        LocNav.AddChoice(
                            cardVM.card_back_text,
                            "Musimy dotrzec do Ministerstwa. Przesuwaj kartę w prawo lub lewo, by się przemieszczać.",
                            left = locleft.name,
                            right = locright.name
                        )
            ...
            "1" -> {
                ...
                when (motionLayout.getCurrentState()) {
                    ...
                    R.id.right -> {
                        ...
                        LocNav.AddChoice(
                            cardVM.card_back_text, "No dobra! Co tym razem do picia?",
            ...
            "11" -> {
                ...
                if (Tutorial.shots != 5) {
                    ...
                    cardVM.FlipFront_instant()
                    LocNav.AddChoice(
                        cardVM.card_back_text, "Pijesz go?", "Nie, dawaj inny,",
